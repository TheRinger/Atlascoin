...
#ifndef ATLAS_TEST_SCRIPTNUM10_H
#define ATLAS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Atlas Core 0.10.0, for cross-comparison.
 */
public:
