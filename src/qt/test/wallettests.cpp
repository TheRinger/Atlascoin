...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<AtlasAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_atlas-qt -platform xcb      # Linux
//     src/qt/test/test_atlas-qt -platform windows  # Windows
//     src/qt/test/test_atlas-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = AtlasUnits::formatWithUnit(unit, balance, false, AtlasUnits::separatorAlways);
    ...
    // Amount input
    AtlasAmountField* amountInput = receiveCoinsDialog.findChild<AtlasAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: atlas:")) != -1);
