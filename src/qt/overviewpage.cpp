...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(AtlasUnits::ATL),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(AtlasUnits::formatWithUnit(unit, balance, false, AtlasUnits::separatorAlways));
    ui->labelUnconfirmed->setText(AtlasUnits::formatWithUnit(unit, unconfirmedBalance, false, AtlasUnits::separatorAlways));
    ui->labelImmature->setText(AtlasUnits::formatWithUnit(unit, immatureBalance, false, AtlasUnits::separatorAlways));
    ui->labelTotal->setText(AtlasUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, AtlasUnits::separatorAlways));
    ui->labelWatchAvailable->setText(AtlasUnits::formatWithUnit(unit, watchOnlyBalance, false, AtlasUnits::separatorAlways));
    ui->labelWatchPending->setText(AtlasUnits::formatWithUnit(unit, watchUnconfBalance, false, AtlasUnits::separatorAlways));
    ui->labelWatchImmature->setText(AtlasUnits::formatWithUnit(unit, watchImmatureBalance, false, AtlasUnits::separatorAlways));
    ui->labelWatchTotal->setText(AtlasUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, AtlasUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the ATL balance grid from expanding and looking terrible when asset balance is hidden
