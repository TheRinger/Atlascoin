...
#ifndef ATLAS_QT_ATLASUNITS_H
#define ATLAS_QT_ATLASUNITS_H
...
/** Atlas unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AtlasUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AtlasUnits(QObject *parent);

    /** Atlas units.
      @note Source: https://en.atlas.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ATL,
...
typedef AtlasUnits::Unit AtlasUnit;

#endif // ATLAS_QT_ATLASUNITS_H
