...
from test_framework.test_framework import AtlasTestFramework, SkipTest
...
class ZMQTest (AtlasTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that atlas has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("atlasd has not been built with zmq enabled.")
