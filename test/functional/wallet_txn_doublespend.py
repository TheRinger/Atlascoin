...
class TxnMallTest(AtlasTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 ATL:
        ...
        # First: use raw transaction API to send 1240 ATL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ATL coin each
        ...
        # Node0's balance should be starting balance, plus 50ATL for another
        ...
        # Node0's total balance should be starting balance, plus 100ATL for 
