...
By default, atlasd will dump mempool on shutdown and
...
class MempoolPersistTest(AtlasTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give atlasd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent atlasd from writing mempool.dat to disk. Verify that `savemempool` fails")
