...
class BIP66Test(AtlasTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # atlasd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and atlasd produces more specific reject
            # reasons.
