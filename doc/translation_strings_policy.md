...
This document provides guidelines for internationalization of the Atlas Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `atlas_en.ts` remains unchanged.
