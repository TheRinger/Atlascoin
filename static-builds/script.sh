...
find ${DISTNAME}/bin -type f -executable -exec ../atlascoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../atlascoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/atlascoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/atlascoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
