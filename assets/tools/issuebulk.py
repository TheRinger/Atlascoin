#!/usr/bin/env python3
# Script to issue assets on the Atlascoin platform
...
# Prerequisite: atlasd daemon to be running
...
#Set this to your atlas-cli program
cli = "atlas-cli"
...
#mode =  "-regtest"
#rpc_port = 18443
csv_file = "Atlas Assets - Sheet1.csv"
#Set this information in your atlas.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
